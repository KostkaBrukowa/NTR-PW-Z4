...
export type FetchSingleNoteQuery = (
  { __typename?: 'Query' }
  & { note: Maybe<(
    { __typename?: 'Note' }
    & Pick<Note, 'noteID' | 'title' | 'description' | 'categories' | 'markdown' | 'rowVersionString'>
  )> }
);
...
export type FetchAllNotesQuery = (
  { __typename?: 'Query' }
  & { notes: (
    { __typename?: 'PaginatedResponse' }
    & Pick<PaginatedResponse, 'total'>
    & { values: Array<(
      { __typename?: 'Note' }
      & Pick<Note, 'noteID' | 'title' | 'description' | 'noteDate' | 'markdown' | 'rowVersionString'>
    )> }
  ) }
);
 ...
 * });
 */
export function useFetchSingleNoteQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchSingleNoteQuery, FetchSingleNoteQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchSingleNoteQuery, FetchSingleNoteQueryVariables>(FetchSingleNoteDocument, baseOptions);
      }
export function useFetchSingleNoteLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchSingleNoteQuery, FetchSingleNoteQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchSingleNoteQuery, FetchSingleNoteQueryVariables>(FetchSingleNoteDocument, baseOptions);
        }
...
export type FetchSingleNoteQueryResult = ApolloReactCommon.QueryResult<FetchSingleNoteQuery, FetchSingleNoteQueryVariables>;
 ...
 * });
 */
export function useSaveNoteMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<SaveNoteMutation, SaveNoteMutationVariables>) {
...
export type SaveNoteMutationOptions = ApolloReactCommon.BaseMutationOptions<SaveNoteMutation, SaveNoteMutationVariables>;
 ...
 * });
 */
export function useFetchAllCategoriesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchAllCategoriesQuery, FetchAllCategoriesQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchAllCategoriesQuery, FetchAllCategoriesQueryVariables>(FetchAllCategoriesDocument, baseOptions);
      }
export function useFetchAllCategoriesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchAllCategoriesQuery, FetchAllCategoriesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchAllCategoriesQuery, FetchAllCategoriesQueryVariables>(FetchAllCategoriesDocument, baseOptions);
        }
...
export type FetchAllCategoriesQueryResult = ApolloReactCommon.QueryResult<FetchAllCategoriesQuery, FetchAllCategoriesQueryVariables>;
 ...
 * });
 */
export function useFetchAllNotesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchAllNotesQuery, FetchAllNotesQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchAllNotesQuery, FetchAllNotesQueryVariables>(FetchAllNotesDocument, baseOptions);
      }
export function useFetchAllNotesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchAllNotesQuery, FetchAllNotesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchAllNotesQuery, FetchAllNotesQueryVariables>(FetchAllNotesDocument, baseOptions);
        }
